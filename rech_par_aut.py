...
"text-decoration: underline;")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Recherche par Auteur"))
        self.lineEdit.setPlaceholderText(_translate("Dialog", "Nom et prenom d\'Auteur"))
