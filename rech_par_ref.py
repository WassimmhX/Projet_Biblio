...
"text-decoration: underline;")
        ...
        self.horizontalLayout_3.addWidget(self.tableWidget, 0, QtCore.Qt.AlignTop)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Recherche par Référence"))
        self.lineEdit.setPlaceholderText(_translate("Dialog", "Référence"))
