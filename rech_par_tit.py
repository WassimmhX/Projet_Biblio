...
class Ui_Dialog18(object):
    def setupUi(self, Dialog):
        Dialog.setObjectName("Dialog")
        Dialog.resize(633, 520)
...
"text-decoration: underline;")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Recherche par Titre"))
        self.lineEdit.setPlaceholderText(_translate("Dialog", "Titre"))
